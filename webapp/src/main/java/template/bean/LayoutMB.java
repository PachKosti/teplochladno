...
import template.config.AdminConfig;
import template.config.ControlSidebarConfig;
...
public class LayoutMB implements Serializable {
    ...
    private static final String DEFAULT_TEMPLATE = "/resources/admin.xhtml"; //template bundled in admin-template
    private static final String TEMPLATE_TOP = "/resources/admin-top.xhtml"; //template bundled in admin-template
    private static final String APP_TEMPLATE_PATH = "/resources/templates/template.xhtml"; // application template (left menu)
    private static final String APP_TEMPLATE_TOP_PATH = "/resources/templates/template-top.xhtml"; //application template (top menu)
    private static final String RESOURCES_PREFFIX = "/resources/"; // template resources preffix path
